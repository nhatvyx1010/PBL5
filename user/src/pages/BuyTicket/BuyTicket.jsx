...
const BuyTicket = () => {
    ...
    // console.log("schedulessss: ", schedules );
    ...
    const handleDelete = (key) => {
        ...
        console.log("Deselect: ", seatSelection, key.scheduleId, key.seatNumber, key.carriageId);
    ...
    const handleInputValidation = (isValid) => {
        ...
        console.log("inputValid: "+isValid);
    };
